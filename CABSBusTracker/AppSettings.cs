...
namespace CABSBusTracker
{
    public class AppSettings
    {
        ...
        const string RefreshCheckBoxSettingKeyName = "RefreshCheckBoxSetting";
        const string NotificationsCheckBoxSettingKeyName = "NotificationsCheckBoxSetting";
        const string LastTrialDisplayDaysName = "LastTrialDisplaySetting";
        ...
        const bool RefreshCheckBoxSettingDefault = false;
        const bool NotificationsCheckBoxSettingDefault = false;
        const int LastTrialDisplayDaysDefault = -1;
        ...
        /// </summary>
        public bool RefreshCheckBoxSetting
        {
            get
            {
                return GetValueOrDefault<bool>(RefreshCheckBoxSettingKeyName, RefreshCheckBoxSettingDefault);
            }
            set
            {
                if (AddOrUpdateValue(RefreshCheckBoxSettingKeyName, value))
                {
                    Save();
                }
            }
        ...
        public bool NotificationsCheckBoxSetting
        {
            get
            {
                return GetValueOrDefault<bool>(NotificationsCheckBoxSettingKeyName, NotificationsCheckBoxSettingDefault);
            }
            set
            {
                if (AddOrUpdateValue(NotificationsCheckBoxSettingKeyName, value))
                {
                    Save();
                }
            }
        ...
        public int TrialDisplayDays
        {
            get
            {
                return GetValueOrDefault<int>(LastTrialDisplayDaysName, LastTrialDisplayDaysDefault);
            }
            set
            {
                if (AddOrUpdateValue(LastTrialDisplayDaysName, value))
                {
                    Save();
                }
            }
